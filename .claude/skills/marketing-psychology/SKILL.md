...
Read `/brain/positioning-and-messaging.md` and `/brain/truth.md` before applying mental models. Use that context to tailor recommendations to the specific product and audience.
