...
**Output location:** `marketing/plans/content-strategy/[strategy-slug]/` — all strategy docs from a single run share this folder. Confirm the slug with the user before creating files.
...
- **seo-geo**: For technical SEO and on-page optimization
