...
- Accessibility minimums (labels always visible, ARIA, `aria-live` error announcements)
- Anti-patterns (no floating labels, no pill shapes, etc.)
- The HubSpot new form renderer (`hsfc-*` classes, `--hsf-background__padding`, cascade fix) — critical, not documented anywhere else
