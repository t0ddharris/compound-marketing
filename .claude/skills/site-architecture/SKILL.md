...
**Output location:** `marketing/plans/site-architecture/` — confirm the project slug with the user before creating files.
...
- **seo-geo**: For technical SEO, on-page optimization, and indexation issues
