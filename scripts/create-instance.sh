...
echo "  Creating $COMPANY Compound Marketing instance at $TARGET..."
...
# Compound Marketing runtime configuration
...
git init -q
git add -A
git commit -q -m "Initial setup: $COMPANY Compound Marketing instance"
